        ...
        <div className="flex items-center gap-4 px-6 py-3 border-b border-slate-200 dark:border-slate-700 overflow-x-auto">
          ...
          {isPremium && (
            <>
              <div className="w-px h-10 bg-slate-200 dark:bg-slate-700 flex-shrink-0" />
              <button
                onClick={() => exportSessionsToCSV(true)}
                className="flex-shrink-0 flex items-center gap-1.5 px-3 py-2 rounded-xl border border-slate-200 dark:border-slate-700 text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors text-xs font-medium"
