  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center px-8 py-12 bg-gradient-to-br from-[#E0F2FE] via-[#EEF2FF] to-[#93C5FD] dark:from-[#0F172A] dark:via-[#1E293B] dark:to-[#0F172A] transition-colors duration-500">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="w-full max-w-xs mb-10 flex items-center justify-center gap-3 bg-white/30 dark:bg-white/10 text-slate-700 dark:text-slate-300 text-sm font-medium py-3 px-6 rounded-2xl border border-white/40 dark:border-white/10 active:scale-95 transition-transform"
      >
