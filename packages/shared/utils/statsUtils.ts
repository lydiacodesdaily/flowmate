...
export const STATS_STORAGE_KEY = "flowmate_user_stats";
...
export const getTodayStats = (stats: UserStats): DailyStat => {
...
export const getRecentStats = (stats: UserStats, days: number = 7): DailyStat[] => {
  const sortedStats = [...stats.dailyStats].sort((a, b) =>
    b.date.localeCompare(a.date)
  );
